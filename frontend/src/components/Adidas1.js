...
Command: npx gltfjsx@6.2.10 adidas1.gltf 
*/
...
export default function Jacket(props) {
  ...
  const { nodes, materials } = useGLTF('/Jacket/adidas1.gltf');
    ...
    <group
     ...
     >
      ...
      <group position={[0, -5.5, 0]}>
        ...
        <mesh
          castShadow
          material-color={snap.design1}
          geometry={nodes.defaultMaterial002_2.geometry}
          material={materials.design1}
        />
        <mesh
          castShadow
          material-color={snap.design2}
          geometry={nodes.defaultMaterial002_3.geometry}
          material={materials.design2}
        />
        <mesh
          castShadow
          material-color={snap.design3}
          geometry={nodes.defaultMaterial002_4.geometry}
          material={materials.design3}
        />
      </group>
    </group>
  )
...
useGLTF.preload('/Jacket/adidas1.gltf')
